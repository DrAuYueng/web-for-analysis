 ...
 * Acts as a simple facade over {@link AnnotatedBeanDefinitionReader},
 * {@link XmlBeanDefinitionReader} and {@link ClassPathBeanDefinitionScanner}.
 * See {@link SpringApplication} for the types of sources that are supported.
 * 
 * @author Phillip Webb
...
class BeanDefinitionLoader {
    ...
    /**
     * Create a new {@link BeanDefinitionLoader} that will load beans into the
     * specified {@link BeanDefinitionRegistry}.
     * 
     * @param registry the bean definition registry that will contain the loaded
     *            beans
    ...
    /**
     * Set the bean name generator to be used by the underlying readers and
     * scanner.
     * 
    ...
    private boolean isComponent(Class<?> type) {
        // This has to be a bit of a guess. The only way to be sure that this
        // type is
        // eligible is to make a bean definition out of it and try to
        // instantiate it.
        if (AnnotationUtils.findAnnotation(type, Component.class) != null) {
            return true;
        }
        // Nested anonymous classes are not eligible for registration, nor are
        // groovy
        // closures
    ...
    /**
     * Simple {@link TypeFilter} used to ensure that specified {@link Class}
     * sources are not accidentally re-added during scanning.
     */
