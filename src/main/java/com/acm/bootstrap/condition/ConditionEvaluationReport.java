...
public class ConditionEvaluationReport {
    ...
    private void addNoMatchOutcomeToAncestors(String source) {
        ...
        for (Entry<String, ConditionAndOutcomes> entry : this.outcomes.entrySet()) {
            if (entry.getKey().startsWith(prefix)) {
                ConditionOutcome outcome = new ConditionOutcome(false, "Ancestor '" + source + "' did not match");
    ...
    /**
     * Obtain a {@link ConditionEvaluationReport} for the specified bean
     * factory.
     * 
    ...
    public static class ConditionAndOutcome {
        ...
        public boolean equals(Object obj) {
            ...
            return (ObjectUtils.nullSafeEquals(this.condition.getClass(), other.condition.getClass()) && ObjectUtils
                    .nullSafeEquals(this.outcome, other.outcome));
        }
